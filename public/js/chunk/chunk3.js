            ...
            [
              _c(
                "el-checkbox",
                {
                  ...
                  model: {
                    value: _vm.articleForm.encryptionORvue,
                    callback: function($$v) {
                      _vm.$set(_vm.articleForm, "encryptionORvue", $$v)
                    },
                    expression: "articleForm.encryptionORvue"
                  }
                },
                [_vm._v("页面加密")]
              ),
