<template>
    <div>
        ...
        <Table v-on:tools="handleTools" ref="table" :url="url" :columns="columns" :checkbox="false"></Table>

        <el-dialog title="客户反馈" :visible.sync="centerDialogVisible" width="30%" center>
            <span>{{content}}</span>
...
<script>
    ...
    import {contactEdit} from "@/api/contact"
    ...
    export default {
                                ...
                                return h('el-select', {
                                        ...
                                        on: {
                                            'change': (event) => {
                                                ...
                                                contactEdit(this.row.id, {status: event})
                                            }
                                        },
                                    },
                                    [
        ...
        methods: {
            ...
            ok(){
                contactEdit(this.id, {remark:this.remark}).then(response=>{
