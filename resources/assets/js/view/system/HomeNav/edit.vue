...
<script>
    ...
    import {NavGet,NavEdit,SeoList} from "@/api/nav";
    ...
    export default {
        ...
        data() {
            return {
                ...
                rules: {
                    ...
                    link: [
                        { required: true, message: '导航地址必须填写', trigger: 'blur' },
                    ],
                },
                option:[],
            }
        ...
        methods: {
            onSubmit() {
                if (this.handleValid()){
                    this.handleSubmit(NavEdit(this.id,this.form))
                }
            },
            success(respon) {
